...
<footer class="flex flex-col items-start p-10 gap-10 mt-10 bg-gray-900 text-white">
    ...
    <span class="w-full flex justify-center items-center gap-5 mt-5"><IconCopyright /> 2024 - Sajidur Rahman</span>
</footer>
